...
namespace PKFramework.Scene.Editor
{
    public class SceneMenu: Menu<SceneConfig>
    {
        ...
        private void InitScene()
        {
            ...
            AssetDatabase.LoadAssetAtPath<GameObject>("Assets/PKFramework/Scene/Prefabs/SceneContext.prefab"));
            sceneContextObject.name = "SceneContext";
            
            var sceneObject = Object.Instantiate(
                AssetDatabase.LoadAssetAtPath<GameObject>("Assets/PKFramework/Scene/Prefabs/NewScene.prefab"));
        ...
        {
            //Controller script
            var ns = SceneConfig.SceneRootPath.Replace('/', '.').Replace(".Scripts", "");
            ns = $"{ns}.{SceneName}";
