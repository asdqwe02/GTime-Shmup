...
namespace PKFramework.Utils
{
    public static class ConfigHelper
    {
        private const string CONFIG_PATH = "Assets/PKFramework/Resources/PKSettings";
        // ReSharper disable once UnusedMember.Local
        private const string RUNTIME_CONFIG_PATH = "PKSettings";
